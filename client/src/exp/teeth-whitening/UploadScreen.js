...
import { ApplyMakeoKitScreen } from './ApplyMakeoKitScreen';

export function UploadScreen({ setImages, images }) {
  ...
  if (images && !images.after && images.before) {
    return (
      <ApplyMakeoKitScreen
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ fontSize: '20px', margin: '36px 0', textAlign: 'center' }}
        >
